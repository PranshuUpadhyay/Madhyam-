      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6 text-sm">
        ...
        <div className="text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start space-x-3 text-lg mb-4">
            <a href="https://www.linkedin.com/in/pranshuupadhyay23" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer"><FaLinkedinIn /></a>
            <a href="https://www.instagram.com/madhyamorg19?igsh=czI5a3VrMDltdjV6" aria-label="Instagram" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
            <a href="https://x.com/MadhyamOrg" aria-label="Twitter" target="_blank" rel="noopener noreferrer"><FaXTwitter /></a>
